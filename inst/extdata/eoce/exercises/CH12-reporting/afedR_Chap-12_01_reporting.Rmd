...
Observe the data available in the `grunfeld.csv` file. Import the data into R using package `afedR` and create a descriptive table of the variables. This table should provide enough information for the reader to understand the data. Use `xtable` package to report it in _LaTeX_ or Word/Writer format.
