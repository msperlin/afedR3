...
With package `simfinapi`, download the PL (profit/loss) statement for FY (final year) data for TESLA (ticker = `r ticker`) for year `r year`.  What is the latest Profit/Loss of the company for that particular year?
