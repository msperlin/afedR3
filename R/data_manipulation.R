...
#'
#' @examples
#' x <- replace_outliers_df(data.frame(x = runif(100)))
replace_outliers_df <- function(df_in, my_prob = 0.05) {

  l_out <- purrr::map(df_in, replace_outliers, my_prob = my_prob)
